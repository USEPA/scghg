...
This repo provides replication instructions for estimating the social cost of greenhouse gases (SC-GHGs) as outlined in the September 2022 draft technical report "Report on the Social Cost of Greenhouse Gases: Estimates Incorporating Recent Scientific Advances" developed by the U.S. Environmental Protection Agency. For more information about the report and peer review process, see [EPA's SC-GHG website](www.epa.gov/environmental-economics/scghg). SC-GHG estimation for each gas in each emissions year comes from three equally-weighted damage modules. The three damage modules are:
